...
class AccessoryWidgetEditViewController: HAFormViewController, TypedRowControllerType {
    var row: RowOf<ButtonRow>!
    /// A closure to be called when the controller disappears.
    public var onDismissCallback: ((UIViewController) -> Void)?

    let config: AccessoryWidget
    private var displayTemplate: AccessoryWidgetTemplate
    ...
    override func viewDidLoad() {
        ...
        let textSections = AccessoryWidgetTextAreas.allCases.map({ addComplicationTextAreaFormSection(location: $0) })
        ...
        form
            ...
            <<< PushRow<AccessoryWidgetTemplate> {
                $0.tag = "template"
    ...
    func addComplicationTextAreaFormSection(location: AccessoryWidgetTextAreas) -> Section {
